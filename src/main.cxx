...
main (int argc, char * const argv [])
{
  ...
  try {
    ...
    * cjh2cjh:
    *
    * ENABLE_NLS: whether native language support is enable
    * LC_ALL: all categories of locale
    * setlocale(LC_ALL, ""): since "" was specified, search for locale in environment variables(LC_ALL, same name as the category,
    * LANG). This line of code is portable.
    * 
    * PACKAGE: systemtap's package name, a macro defined in 'config.h' that was generated by './configure'
    * LOCALEDIR: a macro defined in command line during preprocessing and compiling, typically it is '${prefix}/share/locale'
    * bindtextdomain: set the directory(LOCALEDIR/locale/category/PACKAGE.mo) to find the message catalog
    * textdomain: set the name of the message catalog.
    *
    * setlocale, bindtextdomain, textdomain: together these three function calls do preparation job for subsequent call of 'gettext'.
    * Given a msgid, gettext's translation lookup operates in the context of the current locale which was set by setlocale, and the
    * category used was LC_MESSAGES. For example, gettext would look for translated version of msgid in 
    ...
    */
    ...
    return (rc) ? EXIT_FAILURE : EXIT_SUCCESS;
       ...
       * cjh2cjh:
       *
       * exception: defined in <exception> in namespace std
